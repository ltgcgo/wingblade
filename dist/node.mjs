...
"use strict";import{WebSocket,WebSocketServer as WebSocketService}from"ws";import{fetch,Request,Response}from"undici";import os from"node:os";import fs from"node:fs";import http from"node:http";import crypto from"node:crypto";import dns from"node:dns";import workerThreads from"node:worker_threads";if(!globalThis.self){globalThis.self=globalThis};let __defProp = Object.defineProperty;
