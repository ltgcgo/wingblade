...
}, __publicField(_a, "os", os.platform()), __publicField(_a, "variant", "Node"), __publicField(_a, "version", process.version.replace("v", "")), __publicField(_a, "persist", !0), __publicField(_a, "networkDefer", !1), __publicField(_a, "cores", os.cpus().length), __publicField(_a, "perms", perms), _a), envProtected = "delete,get,has,set,toObject".split(","), env = new Proxy({
...
}, __publicField(_a3, "args", process.argv.slice(2)), __publicField(_a3, "rt", rt), __publicField(_a3, "env", env), __publicField(_a3, "file", file_default), __publicField(_a3, "net", net_default), __publicField(_a3, "web", web_default), __publicField(_a3, "util", util_default), _a3);
