...
}), __publicField(_a, "persist", !0), __publicField(_a, "networkDefer", !1), __publicField(_a, "cores", 8), __publicField(_a, "perms", perms), __publicField(_a, "noColor", Deno.noColor), __publicField(_a, "pid", Deno.pid), __publicField(_a, "ppid", Deno.ppid), __publicField(_a, "chdir", Deno.chdir), __publicField(_a, "cwd", Deno.cwd), __publicField(_a, "execPath", Deno.execPath()), __publicField(_a, "gid", Deno.gid), __publicField(_a, "hostname", Deno.hostname), __publicField(_a, "interfaces", Deno.networkInterfaces), __publicField(_a, "loadavg", Deno.loadavg), __publicField(_a, "memoryUsage", Deno.memoryUsage), __publicField(_a, "osUptime", Deno.uptime), __publicField(_a, "systemMemoryInfo", Deno.systemMemoryInfo), __publicField(_a, "uid", Deno.uid), _a), envProtected = "delete,get,has,set,toObject".split(","), env = new Proxy({
